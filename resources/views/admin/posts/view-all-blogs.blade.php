            ...
            <div class="row">
                                    ...
                                    <div class="article-card-inner  d-flex align-items-center">
                                        <div class="card-image">
                                            <a href="{{ route('view.blog', $recentBlog->slug) }}" tabindex="0">
                                                <img
                                                    src="{{ isset($recentBlog->photo) ? Storage::url(tenant('id') . '/' . $recentBlog->photo) : asset('vendor/landing-page2/image/blog-card-img.png') }}">
                                            </a>
                                        </div>
                                ...
                                <div class="article-card-inner">
                                    <div class="article-card-image">
                                        <a href="{{ route('view.blog', $lastBlog->slug) }}">
                                            <img
                                                src="{{ isset($lastBlog->photo) ? Storage::url(tenant('id') . '/' . $lastBlog->photo) : asset('vendor/landing-page2/image/blog-card-img.png') }}">
                                        </a>
                                    </div>
                                        ...
                                        <div class="author-info d-flex align-items-center justify-content-between">
                                            <div class="author-name d-flex align-items-center">
                                                <div class="author-img">
                                                    <img
                                                        src="{{ Storage::url(tenant('id') . '/' . $lastBlogUser->avatar) }}">
                                                </div>
                ...
                <div class="col-lg-8 col-md-7 col-12">
                    <div class="blog-right-side append-blog-data">
                                ...
                                <div class="article-card-inner">
                                    <div class="article-card-image">
                                        <a href="{{ route('view.blog', $blog->slug) }}">
                                            <img
                                                src="{{ isset($blog->photo) ? Storage::url(tenant('id') . '/' . $blog->photo) : asset('vendor/landing-page2/image/blog-card-img-2.png') }}">
                                        </a>
                                    </div>
                                    <div class="article-card-content">
                                        <div class="author-info d-flex align-items-center justify-content-between">
                        ...
                        @endforeach
                        {{ $allBlogs->links('admin.posts.custom.pagination') }}
                    </div>
                </div>
            </div>
        </div>
