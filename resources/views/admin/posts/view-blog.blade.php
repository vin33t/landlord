    ...
    <section class="article-sec pt">
        <div class="container">
                ...
                <div class="col-12">
                    <div class="about-user d-flex align-items-center">
                        <div class="abt-user-info d-flex align-items-center">
                            <div class="abt-image">
                                <img src="{{ Storage::url(tenant('id') . '/' . $user->avatar) }}">
                            </div>
                            <h6>
                        ...
                        <div class="post-lbl">
                            <b>{{ __('Date:') }}</b>{{ App\Facades\UtilityFacades::date_time_format($blog->created_at) }}
                        </div>
                    </div>
                    <div class="section-title">
            ...
            <p>{{ Utility::getsettings('blog_details')
                ...
                : __('Exploring the advantages of implementing multi-tenancy, such as cost savings, scalability, easier
                                                                                                                                                maintenance, and improved security. A comprehensive guide explaining what multi-tenancy is, its
                                                                                                                                                importance, and how it can transform the dashboard development process using Laravel.') }}
            </p>
            <section class="article-image">
                <img src="{{ isset($blog->photo) ? Storage::url(tenant('id') . '/' . $blog->photo) : asset('vendor/landing-page2/image/article-bg.png') }}"
                    width="100%" height="100%">
            </section>
        </div>
    </section>
                        ...
                        <div class="article-card-inner">
                            <div class="article-card-image">
                                <a href="{{ route('view.blog', $oneBlog->slug) }}">
                                    <img
                                        src="{{ isset($oneBlog->photo) ? Storage::url(tenant('id') . '/' . $oneBlog->photo) : asset('vendor/landing-page2/image/blog-card-img-2.png') }}">
                                </a>
                            </div>
                            <div class="article-card-content">
                                ...
                                <p> {!! isset($oneBlog->short_description)
                                    ...
                                    : __('A step-by-step guide on how to configure and implement multi-tenancy in a Laravel application, including tenant
                                                                                                                                                                                                                                                                                                                    isolation and database separation.') !!}
                                </p>
                            </div>
                        </div>
                    </div>
