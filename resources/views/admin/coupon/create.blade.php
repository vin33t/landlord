                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-1 form-group">
                            ...
                            <div class="d-flex radio-check">
                                <div class="form-check form-check-inline form-group col-md-6">
                                    <input type="radio" id="manual_code" value="manual" name="icon_input"
                                        class="form-check-input code" checked="checked">
                                    <label class="custom-control-label" for="manual_code">{{ __('Manual') }}</label>
                                </div>
                                <div class="form-check form-check-inline form-group col-md-6">
                                    <input type="radio" id="auto_code" value="auto" name="icon_input"
                        ...
                        <div class="form-group d-block" id="manual">
                            <input class="form-control font-uppercase" placeholder="{{ __('Enter manual code') }}"
                                name="manualCode" type="text">
                        </div>
