...
@section('title', __('Edit Header Sub Menu'))
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item"><a href="{{ route('landing.header.index') }}">{{ __('Header Settings') }}</a></li>
    <li class="breadcrumb-item">{{ __('Edit Header Sub Menu') }}</li>
@endsection
@section('content')
    <div class="row">
        <div class="col-sm-12">
