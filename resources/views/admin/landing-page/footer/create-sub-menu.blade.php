...
@section('title', __('Create Footer Sub Menu'))
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item"><a href="{{ route('landing.footer.index') }}">{{ __('Footer Settings') }}</a></li>
    <li class="breadcrumb-item">{{ __('Create Footer Sub Menu') }}</li>
@endsection
@section('content')
    <div class="row">
        <div class="col-sm-12">
