                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('name', $testimonial->name, ['class' => 'form-control', 'required', 'placeholder' => __('Enter name')]) !!}
                        </div>
                        <div class="form-group">
                            {{ Form::label('title', __('Title'), ['class' => 'form-label']) }}
                            {!! Form::text('title', $testimonial->title, [
                                'class' => 'form-control',
                                'required',
                        ...
                        <div class="form-group">
                            ...
                            <div id="rateYo" data-rating="{{ $testimonial->rating }}"></div>
                            {!! Form::hidden('rating', $testimonial->rating, ['required', 'id' => 'rating']) !!}
                        </div>
                    </div>
